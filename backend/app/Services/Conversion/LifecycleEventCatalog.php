...
final class LifecycleEventCatalog
{
    ...
    /** 訂閱中 */
    public const SUBSCRIPTION_ACTIVE = 'calendar.subscription_active';

    /** 連用 ≥ 90 天 */
    public const SUSTAINED_USER = 'calendar.sustained_user';

    /** 連用 ≥ 180 天 + 訂閱中 + 母艦消費過 → mother lead pool 進「適合邀請聊加盟」 */
    public const LOYALIST_HIGH = 'calendar.loyalist_high';

    /** 主動分享朵朵建議給朋友 → 強訊號 */
    public const SHARED_DODO_INSIGHT = 'calendar.shared_dodo_insight';
