...
return [
    ...
    'follicular_pick_a_dream' => [
        ...
        'type' => 'track',
        'title' => '寫 3 個小目標',
        'body'  => '舒緩期能量回來了，趁現在寫下這個月想做的 3 件小事。',
    ...
    'follicular_read_article' => [
        ...
        'type' => 'learn',
        'title' => '讀一篇喜歡的文章',
        'body'  => '不是工作要看的、是妳真的想看的那種。舒緩期吸收力好。',
    ...
    'follicular_book_meaningful_event' => [
        ...
        'type' => 'connect',
        'title' => '排一場期待的聚會',
        'body'  => '訂一個跟朋友吃飯、看展、出遊的日子。舒緩期排來最 work。',
    ...
    'sleep_extra_30min' => [
        ...
        'type' => 'sleep',
        'title' => '早 30 分鐘睡',
        'body'  => '經前期身體在工作，多 30 分鐘睡眠 PMS 通常會輕一點。',
    ...
    'luteal_decline_invitation' => [
        ...
        'type' => 'connect',
        'title' => '婉拒一個邀約',
        'body'  => '經前期社交電量低，今天找一個可以推掉的邀約溫柔說不。',
    ...
    'luteal_prep_snacks' => [
        ...
        'type' => 'eat',
        'title' => '備好明天的小點心',
        'body'  => '經前期容易餓，提前準備堅果、水果或地瓜，餓的時候有東西。',
    ...
    'luteal_no_phone_30min_before_bed' => [
        ...
        'type' => 'sleep',
        'title' => '睡前 30 分不滑手機',
        'body'  => '把手機放到房間外或抽屜裡，經前期睡眠淺更要顧入睡品質。',
    ...
    'luteal_reduce_news' => [
        ...
        'type' => 'connect',
        'title' => '少看一次新聞',
        'body'  => '經前期情緒比較容易被牽動，今天少滑一輪 IG / 新聞。',
    ...
    'luteal_water_bottle_visible' => [
        ...
        'type' => 'eat',
        'title' => '水壺放在眼前',
        'body'  => '經前期水腫，多喝水反而消得快。把水壺放手邊提醒自己。',
